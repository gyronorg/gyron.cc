...
$parcel$export(
  module.exports,
  'ExpressPeerServer',
  () => $123f4982a51872b4$export$8c57434a18c696c9
)
$parcel$export(
  module.exports,
  'PeerServer',
  () => $123f4982a51872b4$export$f99d31af51f48b1e
)
...
var $629a620fdd8149f9$export$2e2bcd8739ae039 =
  $629a620fdd8149f9$var$defaultConfig
...
class $7a434f2b8c14dece$export$3ee29d34e33d9116 {
  ...
  addMessageToQueue(id, message) {
    if (!this.getMessageQueueById(id))
      this.messageQueues.set(
        id,
        new (0, $884a4c78775bc4af$export$eb4c623330d4cbcc)()
      )
  ...
  generateClientId(generateClientId) {
    const generateId = generateClientId
      ? generateClientId
      : (0, $cl6Iw$nodecrypto.randomUUID)
...
class $41c352e9bd485a56$export$6fa53df6b5b88df7 {
  ...
  constructor({
    realm: realm,
    config: config,
    checkInterval: checkInterval = $41c352e9bd485a56$var$DEFAULT_CHECK_INTERVAL,
    onClose: onClose,
  }) {
    this.realm = realm
    this.config = config
...
;(function (Errors) {
  ...
  Errors['INVALID_WS_PARAMETERS'] =
    'No id, token, or key supplied to websocket server'
  Errors['CONNECTION_LIMIT_EXCEED'] =
    'Server has reached its concurrent user limit'
})(
  $115ef0ff92fe1a17$export$b8e9cd941e8016ac ||
    ($115ef0ff92fe1a17$export$b8e9cd941e8016ac = {})
)
...
;(function (MessageType) {
  ...
  $115ef0ff92fe1a17$export$80edbf15fa61a4db ||
    ($115ef0ff92fe1a17$export$80edbf15fa61a4db = {})
)
...
class $e9ffe6de55430dbc$export$f47674b57e51ee3b extends (0,
$cl6Iw$nodeevents.EventEmitter) {
  constructor({ server: server, realm: realm, config: config }) {
    ...
    this.socketServer = config.createWebSocketServer
      ...
      : new (0, $cl6Iw$ws.WebSocketServer)(options)
  ...
  _onSocketConnection(socket, req) {
    ...
    const { query: query = {} } = (0,
    $parcel$interopDefault($cl6Iw$nodeurl)).parse(req.url ?? '', true)
    const { id: id, token: token, key: key } = query
    if (!id || !token || !key)
      return this._sendErrorAndClose(
        socket,
        (0, $115ef0ff92fe1a17$export$b8e9cd941e8016ac).INVALID_WS_PARAMETERS
      )
    if (key !== this.config.key)
      return this._sendErrorAndClose(
        socket,
        (0, $115ef0ff92fe1a17$export$b8e9cd941e8016ac).INVALID_KEY
      )
  ...
  _registerClient({ socket: socket, id: id, token: token }) {
    ...
    if (clientsCount >= this.config.concurrent_limit)
      return this._sendErrorAndClose(
        socket,
        (0, $115ef0ff92fe1a17$export$b8e9cd941e8016ac).CONNECTION_LIMIT_EXCEED
      )
  ...
  const handle = (client, message) => {
    ...
    if (destinationClient) {
      ...
      try {
        ...
        else throw new Error('Peer dead')
      } catch (e) {
...
class $379224fea64e1898$export$3deceafe0aaeaa95 {
  constructor(
    realm,
    handlersRegistry = new (0, $89578eeb272510da$export$cfe4a96645b0bbcf)()
  ) {
    ...
    const handleTransmission = (
      client,
      { type: type, src: src, dst: dst, payload: payload }
    ) => {
    ...
    this.handlersRegistry.registerHandler(
      (0, $115ef0ff92fe1a17$export$80edbf15fa61a4db).HEARTBEAT,
      handleHeartbeat
    )
    this.handlersRegistry.registerHandler(
      (0, $115ef0ff92fe1a17$export$80edbf15fa61a4db).OFFER,
      handleTransmission
    )
    this.handlersRegistry.registerHandler(
      (0, $115ef0ff92fe1a17$export$80edbf15fa61a4db).ANSWER,
      handleTransmission
    )
    this.handlersRegistry.registerHandler(
      (0, $115ef0ff92fe1a17$export$80edbf15fa61a4db).CANDIDATE,
      handleTransmission
    )
    this.handlersRegistry.registerHandler(
      (0, $115ef0ff92fe1a17$export$80edbf15fa61a4db).LEAVE,
...
$9d461d6237a76c70$exports = JSON.parse(
...
var $20377580afc1f4e2$export$2e2bcd8739ae039 = ({
  config: config,
  realm: realm,
}) => {
...
const $6519c7a56ba95525$export$bf71da7aebe9ddc1 = ({
  config: config,
  realm: realm,
  ...
  app.get('/', (_, res) => {
    res.send(
      (0, /*@__PURE__*/ $parcel$interopDefault($9d461d6237a76c70$exports))
    )
  })
  app.use(
    '/:key',
    (0, $20377580afc1f4e2$export$2e2bcd8739ae039)({
      config: config,
      realm: realm,
    })
  )
...
const $516a786dc008ff17$export$99152e8d49ca4e7d = ({
  app: app,
  server: server,
  options: options,
}) => {
  ...
  const messageHandler = new (0, $379224fea64e1898$export$3deceafe0aaeaa95)(
    realm
  )
  ...
  const checkBrokenConnections = new (0,
  $41c352e9bd485a56$export$6fa53df6b5b88df7)({
    realm: realm,
    config: config,
    onClose: (client) => {
  ...
  const customConfig = {
    ...config,
    path: (0, $parcel$interopDefault($cl6Iw$nodepath)).posix.join(
      app.path(),
      options.path,
      '/'
    ),
...
module.exports.Peer = (server, options) => {
...
function $123f4982a51872b4$export$f99d31af51f48b1e(options = {}, callback) {
  ...
  if (ssl && Object.keys(ssl).length) {
    server = (0, $parcel$interopDefault($cl6Iw$nodehttps)).createServer(
      ssl,
      app
    )
