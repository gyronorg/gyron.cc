...
export const LessIcon = FC<IconProps>(({ class: className }) => (
  <svg class={classnames('h-3', className)} viewBox="0 0 235.91 101.62">
    <g>
      ...
      <path
        d="M115.58,28.62h8.07v-8.07h24.22v8.07h8.07v8.07h-8.07v-8.07h-24.22v24.22h24.22v8.07h8.07v24.22h-8.07v8.07h-24.22v-8.07 h-8.07v-8.07h8.07v8.07h24.22V60.92h-24.22v-8.07h-8.07V28.62z"
      />
      <path
        d="M164.02,28.62h8.07v-8.07h24.22v8.07h8.07v8.07h-8.07v-8.07H172.1v24.22h24.22v8.07h8.07v24.22h-8.07v8.07H172.1v-8.07 h-8.07v-8.07h8.07v8.07h24.22V60.92H172.1v-8.07h-8.07V28.62z"
      />
    </g>
  </svg>
))
export const TsxIcon = FC<IconProps>(({ class: className }) => (
  <svg class={classnames('h-3', className)} viewBox="0 0 174.64 101.62">
    <g>
      ...
      <path
        d="M61.53,27.86h8.07v-8.07h24.22v8.07h8.07v8.07h-8.07v-8.07H69.6v24.22h24.22v8.07h8.07v24.22h-8.07v8.07H69.6v-8.07h-8.07 v-8.07h8.07v8.07h24.22V60.16H69.6v-8.07h-8.07V27.86z"
      />
      <path
        d="M109.96,19.79h8.07v24.22h8.07v8.07h8.07v-8.07h8.07V19.79h8.07v24.22h-8.07v8.07h-8.07v8.07h8.07v8.07h8.07v24.22h-8.07 V68.23h-8.07v-8.07h-8.07v8.07h-8.07v24.22h-8.07V68.23h8.07v-8.07h8.07v-8.07h-8.07v-8.07h-8.07V19.79z"
      />
    </g>
  </svg>
))
