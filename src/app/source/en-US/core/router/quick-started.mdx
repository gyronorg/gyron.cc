...
Before writing code, you need to know some basics about routing. Routes is the carrier of routes. Only Routes declared under Routes will be matched by routing rules. If you need to use Layout and other scenarios, you can use the [Outlet](<#Nested%20Rendering%20(Outlet)>) component.
...
Use useRouter to get the Router object, which contains all routing related information. Refer to [useRouter](/en-US/core/router/api#useRouter) for the type description of Router.
...
You can also check out the [API](/en-US/core/router/api) documentation to learn more.
