...
Gyron.js 作者开发了一些方便开发者搭建前端环境的工具，比如常用路由管理器和全剧状态管理器。如果你想把某些社区资源适配到 Gyron 中，可以联系我们以获取帮助。
...
Dox 是一个基于 Redux 的 Gyron 状态管理库，它集成了 Redux 的所有功能并且具备响应式的能力。[https://redux.js.org/](https://redux.js.org/)
