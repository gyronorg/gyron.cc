...
If this is your first time building a Gyron.js app, you can check out [Create a new Gyron app](/en-US/docs/tutorial#Create%20a%20New%20Gyron%20App)
...
If you want to use JSX syntax in browser, check out [JSX](/en-US/core/jsx/getting-started).
