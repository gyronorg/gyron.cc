...
[Why Components Should Return a Function](/en-US/docs/reactive#Component%20Update)
...
If you have read this article and just want to confirm the execution order of lifecycles, you can check out the [lifecycle diagram](/en-US/docs/instance#Lifecycle) in the Instance tutorial below.
...
Async components can also do some other things that will be covered in detail in the advanced tutorials. [Async Components](/en-US/docs/async-component)
